	                ...
	                <div class="card-body">
	                    <form method="POST" action="{{ route('videos.update', $video) }}" enctype="multipart/form-data">
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-md-6">
	                                <input id="max_id" type="number" class="form-control @error('max_id') is-invalid @enderror" name="max_id" value="{{$video->max_id}}">
	                            </div>
	                        </div>
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-md-6">
	                                <input id="num_frame" type="number" class="form-control @error('num_frame') is-invalid @enderror" name="num_frame" value="{{$video->num_frame}}">
	                            </div>
	                        </div>
